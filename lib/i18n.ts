...
export const translations = {
  ...
  trendCompletionTitle: { id: "Trend Penyelesaian", en: "Completion Trend" },
  trendCompletionSubtitle: { id: "Persentase habit selesai per hari (7 hari terakhir)", en: "Percentage of habits completed per day (last 7 days)" },
  habitWeeklyTitle: { id: "Habit Mingguan", en: "Weekly Habits" },
  habitWeeklySubtitle: { id: "Jumlah habit yang diselesaikan per hari (7 hari terakhir)", en: "Number of habits completed per day (last 7 days)" },
  last7Days: { id: "7 hari terakhir", en: "last 7 days" },
  outOf7Days: { id: "dari 7 hari", en: "out of 7 days" },
  activeDays: { id: "Hari Aktif", en: "Active Days" },
  taskDistTitle: { id: "Distribusi Task per Prioritas", en: "Task Distribution by Priority" },
  taskDistSubtitle: { id: "Jumlah task berdasarkan tingkat prioritas", en: "Number of tasks by priority level" },
  taskStatusTitle: { id: "Status Task", en: "Task Status" },
  taskStatusSubtitle: { id: "Perbandingan task selesai vs pending", en: "Comparison of completed vs pending tasks" },
  totalTask: { id: "Total Task", en: "Total Tasks" },
  taskCompleted: { id: "Task Selesai", en: "Completed Tasks" },
  highPriority: { id: "Prioritas Tinggi", en: "High Priority" },
  highPrioritySubtitle: { id: "task high priority", en: "high priority tasks" },
  allTasks: { id: "semua task", en: "all tasks" },
  notCompleted: { id: "belum selesai", en: "not completed" },
  trend: { id: "Trend", en: "Trend" },
  habit: { id: "Habit", en: "Habit" },
  task: { id: "Task", en: "Task" },
